							...
							<?php else : ?>
								...
								<ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details">
									...
									<li class="woocommerce-order-overview__name name">
										...
										<strong><?php echo $order->get_billing_last_name(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
												?></strong>
									</li>
									<?php //endif; 
									?>
									...
									?>
									<!-- <strong><?php //echo wp_kses_post($order->get_payment_method_title()); 
													?></strong> -->
									<!-- </li> -->
									<?php //endif; 
									?>
