...
if (!function_exists('lth_section_output_fe')) :
    ...
    if ($attributes['background_image']) {
        $background = 'background: url('.$attributes['background_image']['url'].') no-repeat center; background-size: '.$size.'; background-position: '.$position.'';
