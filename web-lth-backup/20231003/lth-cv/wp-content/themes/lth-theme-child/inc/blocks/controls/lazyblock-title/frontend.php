        ...
        <div class="module_header title-box" style="text-align: <?php echo $attributes['text_align']; ?>; margin-bottom: <?php echo $attributes['margin_bottom']; ?>px;">
            <?php if (!empty($attributes['title'])) : ?>
                <?php if ($attributes['title_tag'] == 'h1') { ?>
                    <h1 class="title" style="font-size: <?php echo $attributes['title_size']; ?>px; <?php echo $title_color; echo $title_transform; echo $title_font_weight; ?>">
                <?php } elseif ($attributes['title_tag'] == 'h2') { ?>
                    <h2 class="title" style="font-size: <?php echo $attributes['title_size']; ?>px; <?php echo $title_color; echo $title_transform; echo $title_font_weight; ?>">
                <?php } elseif ($attributes['title_tag'] == 'h3') { ?>
                    <h3 class="title" style="font-size: <?php echo $attributes['title_size']; ?>px; <?php echo $title_color; echo $title_transform; echo $title_font_weight; ?>">
                <?php } elseif ($attributes['title_tag'] == 'h4') { ?>
                    <h4 class="title" style="font-size: <?php echo $attributes['title_size']; ?>px; <?php echo $title_color; echo $title_transform; echo $title_font_weight; ?>">
                <?php } elseif ($attributes['title_tag'] == 'h5') { ?>
                    <h5 class="title" style="font-size: <?php echo $attributes['title_size']; ?>px; <?php echo $title_color; echo $title_transform; echo $title_font_weight; ?>">
                <?php } elseif ($attributes['title_tag'] == 'h6') { ?>
                    <h6 class="title" style="font-size: <?php echo $attributes['title_size']; ?>px; <?php echo $title_color; echo $title_transform; echo $title_font_weight; ?>">
                <?php } ?>
