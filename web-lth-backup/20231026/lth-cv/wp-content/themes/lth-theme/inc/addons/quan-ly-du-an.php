...
// Đăng ký Phòng Ban cho post type "Quản Lý Dự Án"
function register_quan_ly_du_an_phong_ban() {
    $labels = array(
        'name'              => 'Phòng Ban',
    ...
    $args = array(
        'hierarchical'      => true, // Để có cấu trúc Phòng Ban như "Phòng Ban con" và "Phòng Ban cha"
        'labels'            => $labels,
        'show_ui'           => true,
    ...
    register_taxonomy( 'quan_ly_du_an_phong_ban', 'quan_ly_du_an', $args );
}
add_action( 'init', 'register_quan_ly_du_an_phong_ban' );
            ...
            array(
                ...
                'sub_fields' => array(
                    ...
                    array(
                        ...
                        'taxonomy' => 'quan_ly_du_an_phong_ban',
                        'field_type' => 'select',
                        'allow_null' => 1,
                        'add_term' => 1,
                        'save_terms' => 0,
