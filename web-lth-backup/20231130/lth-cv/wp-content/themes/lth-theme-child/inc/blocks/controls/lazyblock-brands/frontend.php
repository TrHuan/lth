                                        ...
                                        <div class="content-image">
                                            <?php if ($inner['item_name']) { ?>
                                                <a href="#" title="" class="image btn-popup" data_popup="popup-icon-<?php echo str_replace( ' ', '-', vn_str_filter($inner['item_name']) ); ?>">
                                                    <img src="<?php echo esc_url($inner['image']['url']); ?>" alt="<?php echo $inner['item_name']; ?>" width="<?php echo $inner['width_image']; ?>" height="<?php echo $inner['height_image']; ?>" style="max-width: <?php echo $inner['width_image']; ?>px;">
                                                </a>
                                            <?php } else { ?>
                                                <?php if ($inner['url']) : ?>
                                                    <a href="<?php echo esc_url($inner['url']); ?>" title="" class="image">
                                                <?php endif; ?>
                                                    <img src="<?php echo esc_url($inner['image']['url']); ?>" alt="Brand" width="<?php echo $inner['width_image']; ?>" height="<?php echo $inner['height_image']; ?>" style="max-width: <?php echo $inner['width_image']; ?>px;">
                                                <?php if ($inner['url']) : ?>
                                                    </a>
                                                <?php endif; ?>
                                            <?php } ?>
                                                        ...
                                                        <?php if ($inner['image']) : ?>
                                                            <div class="content-image">
                                                                <?php if ($inner['url']) : ?>
                                                                    <a href="<?php echo esc_url($inner['url']); ?>" title="" class="image">
                                                                <?php endif; ?>
                                                                    <img src="<?php echo esc_url($inner['image']['url']); ?>" alt="<?php echo $inner['item_name']; ?>" width="<?php echo $inner['width_image']; ?>" height="<?php echo $inner['height_image']; ?>">
                                                                <?php if ($inner['url']) : ?>
                                                                    </a>
                                                                <?php endif; ?>
                                                            </div>
