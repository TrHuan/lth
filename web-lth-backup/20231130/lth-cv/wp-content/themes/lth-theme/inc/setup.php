...
function lth_theme_setup() {
    ...
    // trình soạn thảo post: đưa về phiên bản cũ
    ...
    if ($column_name == 'featured_image') {
        if (has_post_thumbnail()) {
            if (has_post_thumbnail($post_id)) {
                ...
                echo '<img data-id="' . $thumb_id . '" src="' . wp_get_attachment_url($thumb_id) . '" style="max-width: 120px;width: 100%;" />';
            } else {
                echo '<img data-id="-1" src="' . get_template_directory_uri() . '/assets/images/placeholder.png" style="max-width: 120px;width: 100%;" />';
            }
        }
    }
}
...
// $email_shop = $smtp['smtp_email_shop'];
// $email_pass = $smtp['smtp_email_pass'];
