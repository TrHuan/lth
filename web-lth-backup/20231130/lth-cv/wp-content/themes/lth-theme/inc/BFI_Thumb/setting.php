...
// function custom_no_image( $thumb_size, $image_width, $image_height ) {
//     $params = array( 'width' => $image_width, 'height' => $image_height, 'crop' => true );
//     $imgsrc = ASSETS_URI . '/images/placeholder.png';
...
function lth_custom_imgs_single_product( $thumb_size, $image_width, $image_height ) {
    ...
    if ( $attachment_ids && $product->get_image_id() ) {
        ...
        if (has_post_thumbnail()) {
            ...
            <div class="ul">
                <div class="item">
                    <img src="<?php echo lth_custom_logo('full', 530, 530); ?>" width="530" height="530" alt="<?php the_title(); ?>">
                </div>
            </div>
        <?php }
    }
