 ...
 * @block-output:   lth_teams_output
 * @block-attributes: get from attributes.php
 */

// filter for Frontend output.
add_filter('lazyblock/lth-teams/frontend_callback', 'lth_teams_output_fe', 10, 2);

if (!function_exists('lth_teams_output_fe')) :
    /**
                                ...
                                <div class="post-box">
                                    <?php if (!empty($inner['item_image']['url'])) { ?>
                                        <div class="post-image">
                                            <div class="image">
                                                <img src="<?php echo esc_url($inner['item_image']['url']); ?>" alt="Team" width="<?php echo $attributes['width_image']; ?>" height="<?php echo $attributes['height_image']; ?>">
                                            </div>
                                        </div>
                                    <?php } ?>
