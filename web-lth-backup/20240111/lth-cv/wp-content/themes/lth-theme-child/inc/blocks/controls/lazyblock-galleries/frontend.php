<?php
/**
 * @block-slug  :   lth-galleries
 * @block-output:   lth_galleries_output
 * @block-attributes: get from attributes.php
 */

// filter for Frontend output.
add_filter('lazyblock/lth-galleries/frontend_callback', 'lth_galleries_output_fe', 10, 2);

if (!function_exists('lth_galleries_output_fe')) :
    /**
     ...
     */
    function lth_galleries_output_fe($output, $attributes) {
        ob_start();
?>    
