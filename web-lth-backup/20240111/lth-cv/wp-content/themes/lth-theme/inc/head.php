...
function lth_theme_styles()
{
	...
	wp_enqueue_script(THEME_NAME . '-fancybox', ASSETS_URI . '/js/jquery.fancybox.js', false, THEME_VERSION, 'all');

	wp_enqueue_script(THEME_NAME . '-effects', ASSETS_URI . '/js/effects.js', false, THEME_VERSION, 'all');
