          ...
          if ( $primary_cat_id ) {
              ...
              if ($categories) {
                  ...
                  foreach ($categories as $category) {
                      $cat = $category->name; // Lấy tên chuyên mục
                  }
              }
          }
          // if ( ! is_wp_error( $cat ) ) {
        ...
        <div class="module_button">
            <?php if ( class_exists( 'WPSEO_Primary_Term' ) ) {
                ...
                if ( $primary_cat_id ) {
                    ...
                    if ($cat) {
                      echo '<a href="'. $cat_link .'" title="" class="btn">';
                        echo __('Xem tất cả');
                      echo '</a>';
                    }
                } else {
                    ...
                    if ($categories) {
                      ...
                      foreach ($categories as $category) {
                          ...
                          echo '<a href="' . esc_url($category_url) . '" title="" class="btn">' . __('Xem tất cả') . '</a>';
                      }
                  }
                }
            } ?>
