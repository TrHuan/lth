            ...
            <div class="module_lists">
                ...
                <div class="module_content <?php if ($attributes['list_tag'] == 'table_title' || $attributes['list_tag'] == 'table_content') {echo 'tables-box';} ?>">
                    <?php if ($attributes['list_tag'] != 'ol') { ?>
                        <ul class="lists-text <?php if ($attributes['list_tag'] != 'ul') {echo $attributes['list_tag'] . ' table-box';}?> items-<?php echo $attributes['list_columns']; ?>"
                    ...
                    <?php } else { ?>
                        <ol class="lists-text" <?php if ($attributes['list_columns'] != '1') { ?>style="display: flex;"<?php } ?>>
                    <?php } ?>
