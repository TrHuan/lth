 ...
 * @block-output:   lth_contact_qrcode_output
 * @block-attributes: get from attributes.php
 */

// filter for Frontend output.
add_filter('lazyblock/lth-contact-qrcode/frontend_callback', 'lth_contact_qrcode_output_fe', 10, 2);

if (!function_exists('lth_contact_qrcode_output_fe')) :
    /**
     ...
     */
    function lth_contact_qrcode_output_fe($output, $attributes)
    {
        ob_start();
?>
