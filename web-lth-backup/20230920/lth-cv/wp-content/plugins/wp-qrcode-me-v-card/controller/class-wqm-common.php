...
if ( ! class_exists( 'WQM_Common' ) ) {
	...
	class WQM_Common {
		...
		public function wqm_register_admin_scripts() {
			...
			wp_enqueue_style( 'wqm-select2-styles', '//cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/css/select2.min.css', false, '1.0', 'all' );
			wp_enqueue_script( 'wqm-select2-script', '//cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.min.js', array( 'jquery' ), '1.0', true );
