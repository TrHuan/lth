...
class Widget_Lth_Posts extends Widget_Base {
   ...
   public function __construct($data = [], $args = null) {
      parent::__construct($data, $args);
		...
		foreach( $posts as $post ) {
			$this->choices_post[$post->ID] = $post->post_title.' (Id = '.$post->ID.')';
		}
	...
	protected function _register_controls() {
		...
		*/	
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Choices Posts', 'lth' ),
			]
		);
		...
		$this->add_control(
			'choice_posts',
			[
				'label' => __( 'Choice Posts', 'lth' ),
				'type' => Controls_Manager::SELECT ,
				'label_block' => 'true',
				'title' => __( 'Choice Posts', 'lth' ),
				'default' => 'no',
				'options' => [
					'yes'  => __( 'Yes', 'lth' ),
					'no'  => __( 'No', 'lth' ),
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widget_Lth_Posts() );
