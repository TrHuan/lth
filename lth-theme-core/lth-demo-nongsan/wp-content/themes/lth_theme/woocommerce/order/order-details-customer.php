...
<section class="woocommerce-customer-details">
	...
	<address>
		...
		<?php if ( $order->get_billing_address_1() ) : ?>
			<p class="woocommerce-customer-details--address"><?php echo esc_html( $order->get_billing_address_1() ); ?></p>
		<?php endif; ?>

		<?php if ( $order->get_billing_address_2() ) : ?>
			<p class="woocommerce-customer-details--address"><?php echo esc_html( $order->get_billing_address_2() ); ?></p>
		<?php endif; ?>
