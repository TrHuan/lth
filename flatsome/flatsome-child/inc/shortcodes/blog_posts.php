<?php
function remove_blog_parent_theme_shortcodes() {
    // xoá shortcode element cũ bên theme flatsome
    remove_shortcode('shortcode_latest_from_blog');

    // add shortcode element mới bên theme flatsome-child
    add_shortcode('blog_posts', 'gco_shortcode_latest_from_blog');

}
add_action('init', 'remove_blog_parent_theme_shortcodes');

// [blog_posts]
function gco_shortcode_latest_from_blog($atts, $content = null, $tag = '' ) {
