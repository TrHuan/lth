...
function remove_ux_portfolio_parent_theme_shortcodes() {
  ...
  add_shortcode("featured_items_slider", "gco_flatsome_portfolio_shortcode");
  add_shortcode("featured_items_grid", "gco_flatsome_portfolio_shortcode");
  add_shortcode("ux_portfolio", "gco_flatsome_portfolio_shortcode");

}
add_action('init', 'remove_ux_portfolio_parent_theme_shortcodes');

// [featured_items_slider]
function gco_flatsome_portfolio_shortcode($atts, $content = null, $tag = '' ) {
          ...
          <div class="<?php echo implode(' ', $classes_box); ?>">
            ...
            <div class="<?php echo implode(' ', $classes_text); ?>" <?php echo get_shortcode_inline_css( $css_args ); ?>>
                  <div class="box-text-inner">
                      <h3 class="uppercase portfolio-box-title"><?php the_title(); ?></h3>
                      <p class="uppercase portfolio-box-category is-xsmall op-6">
                        <!-- <span class="show-on-hover"> -->
                         <?php  echo strip_tags( get_the_term_list( get_the_ID(), 'featured_item_category', "",", " ) );?>
                        <!-- </span> -->
                      </p>
                      <p class="uppercase portfolio-box-excerpt is-xsmall op-6">
                        <?php the_excerpt(); ?>
                      </p>
                  </div>
            </div>
