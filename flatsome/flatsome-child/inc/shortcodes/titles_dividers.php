...
function remove_titles_dividers_parent_theme_shortcodes() {
    ...
    add_shortcode('title', 'gco_title_shortcode');
    add_shortcode('divider', 'gco_divider_shortcode');

}
add_action('init', 'remove_titles_dividers_parent_theme_shortcodes');

// [title]
// đổi tên shortcode (title_shortcode) thành (gco_title_shortcode)
function gco_title_shortcode( $atts, $content = null ){
...
// [divider]
// đổi tên shortcode (divider_shortcode) thành (gco_divider_shortcode)
function gco_divider_shortcode( $atts, $content = null ){
  extract( shortcode_atts( array(
    'width' => '',
    'height' => '',
    'margin' => '',
...
return $align_start.'<div class="gco is-divider divider clearfix" '.get_shortcode_inline_css($css_args).'></div>'.$align_end;
