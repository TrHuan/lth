...
function remove_team_member_parent_theme_shortcodes() {
  ...
  add_shortcode('team_member','gco_flatsome_team_member');

}
add_action('init', 'remove_team_member_parent_theme_shortcodes');

function gco_flatsome_team_member($atts, $content = null){
