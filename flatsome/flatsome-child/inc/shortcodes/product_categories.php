...
function remove_ux_product_categories_theme_shortcodes() {
  // xoá shortcode element cũ bên theme flatsome
  remove_shortcode('ux_product_categories');
  remove_shortcode('ux_product_categories_grid');

  // add shortcode element mới bên theme flatsome-child
  add_shortcode("ux_product_categories", "gco_ux_product_categories");
  add_shortcode("ux_product_categories_grid", "gco_ux_product_categories");

}
add_action('init', 'remove_ux_product_categories_theme_shortcodes');

// [ux_product_categories]
function gco_ux_product_categories($atts, $content = null, $tag = '' ) {
  $sliderrandomid = rand();
