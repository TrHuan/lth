...
function remove_ux_products_theme_shortcodes() {
	...
	add_shortcode("ux_bestseller_products", "gco_ux_products");
	add_shortcode("ux_featured_products", "gco_ux_products");
	add_shortcode("ux_sale_products", "gco_ux_products");
	add_shortcode("ux_latest_products", "gco_ux_products");
	add_shortcode("ux_custom_products", "gco_ux_products");
	add_shortcode("product_lookbook", "gco_ux_products");
	add_shortcode("products_pinterest_style", "gco_ux_products");
	add_shortcode("ux_products", "gco_ux_products");

}
add_action('init', 'remove_ux_products_theme_shortcodes');

// Flatsome Products
function gco_ux_products($atts, $content = null, $tag = '' ) {
	$sliderrandomid = rand();
						...
						<div class="product-small <?php echo implode(' ', $classes_box); ?>">
							...
							<div class="box-text <?php echo implode(' ', $classes_text); ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
								<?php
									...
									do_action( 'gco_woocommerce_template_loop_product_title' );
									echo '</div>';
